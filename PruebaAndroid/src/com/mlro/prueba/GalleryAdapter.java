...
public class GalleryAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        //reescalamos la imagen para evitar "javajava.lang.OutOfMemory" en el caso de imágenes de gran resolución
         //como es esteeste ejemplo
         if (imagenesEscaladas.get(position) == null)
         {
             Bitmap bitmap = BitmapUtils.decodeSampledBitmapFromResource(context.getResources(), imagenes[position], 50, 0);
